...
import { Github, Linkedin, Mail, Phone, Copyright, ExternalLink, } from "lucide-react";
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Full Stack Developer & Machine Learning Enthusiast based in Odisha,
              specialized in creating modern web applications, Game Development, 2D&3D
              Artist and blockchain solutions.
            </p>
          </div>
